...
Then, during the actual workshop you will follow the guidelines from the lecturer – but additionally, all materials are available for you inside this very repository. You can follow the steps here: [docs/steps/virtual-workshop/README.md](docs/steps/virtual-workshop/README.md) 
