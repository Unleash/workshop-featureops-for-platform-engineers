...
2. **Clone this repository** and run `make workshop-pre-check`. It installs dependencies and checks your machine: the tools we need (`curl`, `jq`), free app ports, and no stray Unleash variables in your shell.
...
This archives the flags and removes the project-specific segment and project-specific context fields. The project itself is left alone — it's yours, on your instance. Delete it in the UI if you want it gone.
